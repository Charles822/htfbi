"""
Django settings for htfbi_backend project.
...
WSGI_APPLICATION = 'htfbi_backend.wsgi.application'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'debug_toolbar': {
            'handlers': ['console'],
            'level': 'WARNING',  # Suppress debug_toolbar logs
            'propagate': False,
        },
    },
}

# REMEMBER TO CHANGE THESE SETTINGS BEFORE LAUNCH
